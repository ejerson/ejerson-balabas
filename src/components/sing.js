        ...
        <div className='music-div'>
          ...
          <div className='music-philosophy'>
            ...
            <h2 className='page-intro'>
              I want to <span className="word-emphasis">connect</span> with as many people as possible.
              Performing allows one, theoretically, to be <span className="word-emphasis">present</span> and fully <span className="word-emphasis">immersed</span> in the moment, which was my initial <span className="word-emphasis">focus</span>.
              But as I continued working on my musicianship, I gradually realized that this only happens when one has moved beyond <span className="word-emphasis">technique</span>.
