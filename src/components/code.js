  ...
  render() {
    return (
      ...
      <div className='backend-skills'>
        ...
        <h2 className='tech-name'>Java</h2>
        <h2 className='tech-name'>PostgreSQL</h2>
        <h2 className='tech-name'>MySQL</h2>
        <h2 className='tech-name'>Node.js</h2>
      </div>
      <div className='frontend-skills'>
        <h1>Frontend Development</h1>
        <h2 className='tech-name'>JavaScript</h2>
        <h2 className='tech-name'>LESS</h2>
        <h2 className='tech-name'>CSS</h2>
        <h2 className='tech-name'>HTML</h2>
        <h2 className='tech-name'>jQuery</h2>
      </div>
